...
public class Map {
    ...
    /**
     * Returns the obstacle at the given locatin, or null if there is no obstacle at the given location
     * @param x The x coordinate of the location
     * @param y The y coordinate of the location
     * @return The obstacle at the given locaiton, or null if there is no obstacle at the given location
     */
