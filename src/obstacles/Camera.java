...
/**
 * Represents a camera on the map that obstructs all locations in tis cone of visiion.
 */
public class Camera extends LocatableObstacle {
    private final Direction direction;

    /**
     * Constructs a new Camera object with th given location and direction.
    ...
    /**
     * Constrcuts a new Camera object from the given string argument.
